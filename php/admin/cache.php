    ...
    <div class="right_main">
        ...
        <table width="98%" border="0" cellpadding="4" cellspacing="1" class="tableoutline">
            <form action="?id=save" method="post">
                ...
                <tr nowrap class="firstalt">
                    <td width="260"><b>css缓存保存时间</b><br></td>
                    <td><input type="text" name="con[csscachetime]" size="25" maxlength="50" value="<?php echo $v_config['csscachetime'];
                        ?>"onFocus="this.style.borderColor='#00CC00'" onBlur="this.style.borderColor='#dcdcdc'" >H
                    </td>
                </tr>
                <tr nowrap class="firstalt">
                    <td width="260"><b>js缓存保存时间</b><br></td>
                ...
                <tr nowrap class="firstalt">
                    <td width="260"><b>缓存大小限制</b><br></td>
                    <td><input type="text" name="con[cache_size]" size="25" maxlength="50" value="<?php echo $v_config['cache_size'];
                        ?>" onFocus="this.style.borderColor='#00CC00'" onBlur="this.style.borderColor='#dcdcdc'" >MB</td>
                </tr>
                <tr nowrap class="firstalt">
                    <td width="260"><b>定时检查缓存大小时间间隔</b><br></td>
                    <td><input type="text" name="con[delcachetime]" size="25" maxlength="50" value="<?php echo $v_config['delcachetime']; ?>
                        " onFocus="this.style.borderColor='#00CC00'" onBlur="this.style.borderColor='#dcdcdc'" >天</td>
                </tr>
                <tr nowrap class="firstalt">
                    <td width="260"><b>自动清理缓存开关</b><br>
                        <font color="#666666">开启后，超过缓存大小限制就自动清理缓存</font></td>
                    <td>
                        <select name="con[deloldcache]">
