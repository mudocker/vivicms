...
if(is_file($file)){
    $arr = file($file);
    $zongshu = count($arr);
    $count = array('baidu' => 0, 'baidu_today' => 0, 'baidu_yestoday' => 0, '360' => 0, '360_today' => 0, '360_yestoday' => 0, 'google' => 0, 'google_today' => 0, 'google_yestoday' => 0, 'shenma' => 0, 'shenma_today' => 0, 'shenma_yestoday' => 0, 'sogou' => 0, 'sogou_today' => 0, 'sogou_yestoday' => 0, 'yahoo' => 0, 'yahoo_today' => 0, 'yahoo_yestoday' => 0, 'other' => 0, 'other_today' => 0, 'other_yestoday' => 0,);
    if($arr){
        foreach($arr as $i => $v){
            ...
            if(date("Y-m-d", strtotime($time)) == date("Y-m-d", strtotime("-1 day"))){
                if($name == 'Baidu'){
                    ...
                    $count['yahoo_yestoday']++;
                }else{
                    $count['other_yestoday']++;
                }
            }
        ...
        $pages = get_page($page, $totalpages, $pageurl);
    }
}
?>
<style type="text/css">
...
?></td>
				<td><?php echo $count['google_today'];
?></td>
				<td><?php echo $count['shenma_today'];
?></td>
				<td><?php echo $count['sogou_today'];
?></td>
				<td><?php echo $count['yahoo_today'];
?></td>
				<td><?php echo $count['other_today'];
?></td>
			</tr>
			<tr class="firstalt">
				<td>昨日</td>
...
?></td>
				<td><?php echo $count['google_yestoday'];
?></td>
				<td><?php echo $count['shenma_yestoday'];
?></td>
				<td><?php echo $count['sogou_yestoday'];
?></td>
				<td><?php echo $count['yahoo_yestoday'];
?></td>
				<td><?php echo $count['other_yestoday'];
?></td>
			</tr>
			<tr class="firstalt">
				<td>合计</td>
...
?></td>
				<td><?php echo $count['google'];
?></td>
				<td><?php echo $count['shenma'];
?></td>
				<td><?php echo $count['sogou'];
?></td>
				<td><?php echo $count['yahoo'];
?></td>
				<td><?php echo $count['other'];
?></td>
			</tr>
		</table>
	</td>
...
<?php if($type){
	...
	<tr nowrap class="firstalt">
		<td colspan="8"><font color="blue">当前为“ <font color="red"><?php echo $type;
    ?></font> ”的结果，<a href="?">查看全部</a></font></td>
	</tr>
	<?php }
?>
 <tr nowrap class="firstalt">
...
<?php }
    ?>
	<tr class="firstalt">
		<td align="center" colspan="5"><ul class="page"><?php echo $pages;
    ?></ul></td>
	</tr>
<?php }else{
    ?>
