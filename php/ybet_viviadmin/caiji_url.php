...
if($id == ''){
    ...
    $suffix = $v_config['web_urlencode_suffix']?$v_config['web_urlencode_suffix']:'html';
    ?>
<body>
<div class="right">
  ...
  <table width="98%" border="0" cellpadding="4" cellspacing="1" class="tableoutline">
	...
	<tr nowrap class="firstalt">
		...
		<td><select name="con[web_urlencode]" >
			<option value="1" <?php if($v_config['web_urlencode'])echo " selected";
    ?>>开启</option>
			<option value="0" <?php if(!$v_config['web_urlencode'])echo " selected";
    ?>>关闭</option>
		</select></td>
	</tr>
	<tr nowrap class="firstalt">
    ...
    ?>>base64</option>
			<option value="jiandan" <?php if($v_config['web_urlencode_type'] == 'jiandan')echo " selected";
    ?>>简单转换</option>
			<option value="str_rot13" <?php if($v_config['web_urlencode_type'] == 'str_rot13')echo " selected";
    ?>>转换字母</option>
		</select></td>
	</tr>
	<tr nowrap class="firstalt">
