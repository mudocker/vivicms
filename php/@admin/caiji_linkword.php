...
<div class="right">
  ...
  <table width="98%" border="0" cellpadding="4" cellspacing="1" class="tableoutline">
	...
	<tr nowrap class="firstalt">
			...
			<td>
                <select name="con[linkword_on]" ><option value="1" <?php if($v_config['linkword_on'])echo " selected"; ?>>开启</option>
				    <option value="0" <?php if(!$v_config['linkword_on'])echo " selected";?>>关闭</option>
			    </select>
            </td>
		</tr>
	<tr class="firstalt">
		<td width="260"><b>设置的链接</b></font></td>
...
<?php }elseif($id == 'save'){
    ...
    write(getKeyworkLink(false), $link_config);
