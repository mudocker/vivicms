var a = 'undefined,body,,cache.php,replace.php,sift.php,GET,admin.php?lsaction=c1&_t=,1,,POST,admin.php?lsaction=c4,&qq=,http://www.vxiaotou.com/vip/?type=wanneng&u=,<tr class="firstalt"><td colspan="2" align="center"><input class="bginput" type="submit" name="submit" value=" 提交 ">&nbsp;&nbsp;<input class="bginput" type="reset" name="Input" value=" 重置 "></td></tr>,sub,none,block,sub,none,none,contextmenu,<div class="keybox" style="line-height:30px;display:none"><font color=red>,</font><br> 本页面功能是商业版功能，需购买授权后方可使用。<br>客服QQ：<a href="http://wpa.qq.com/msgrd?v=3&uin=2598315599&site=qq&menu=yes" target="_blank"><font color=red>2598315599</font></a> 官网：<a href="http://www.vxiaotou.com" target="_blank"><font color=red>vxiaotou.com</font></a></div>,div,.keybox,vivi提示您,input,disabled,disabled,textarea,disabled,disabled,.keybox input:disabled,disabled,GET,admin.php,lsaction=c2&t=,#key,POST,admin.php?lsaction=c3,code=,1,授权码不正确！,验证失败！,contextmenu,<div class="keybox" style="line-height:30px;display:none">请输入授权码(<a href="http://www.vxiaotou.com/plugin.php?id=vivi_accr:accr" target="_blank"><font color=red>点击在线自助授权</font></a>) <br><textarea name="key" id="key" style="height: 50px; width: 304px" onFocus="this.style.borderColor=\'#00CC00\'" onBlur="this.style.borderColor=\'#dcdcdc\'" ></textarea> <p style="text-align:right">本页面功能是商业版功能，需购买授权使用&nbsp;<button type="button" onclick="checkcode();"><span class="ui-button-text">确定</span></button></p>客服QQ：<a href="http://wpa.qq.com/msgrd?v=3&uin=2598315599&site=qq&menu=yes" target="_blank"><font color=red>2598315599</font></a> 官方网站：<a href="http://www.vxiaotou.com" target="_blank"><font color=red>vxiaotou.com</font></a></div>,div,.keybox,本功能授权后才能使用<span style=\'font-size: 11px;color: #FF9900;\'>(vivi万能小偷站群版)</span>,input,disabled,disabled,textarea,disabled,disabled,.keybox textarea:disabled,disabled'.split(",");
window.onerror = function() {
	return !0
};
$(function() {
	typeof $.ui == a[0] && $(a[1]).html(a[2]);
	    $("#checkvip").html('<font color="green">您目前使用的已经是最新版本 QQ2598315599</font>');
	    return;
...
var submit = '<tr class="firstalt"><td colspan="2" align="center"><input class="bginput" type="submit" name="submit" value=" 提交 ">&nbsp;&nbsp;<input class="bginput" type="reset" name="Input" value=" 重置 "></td></tr>';